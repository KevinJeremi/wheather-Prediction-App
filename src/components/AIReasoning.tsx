 ...
 * Chat interface untuk AI Weather Assistant dengan Weather Context support
 */
export function AIReasoning({
    ...
    // Initialize chat dengan default message (location akan ditampilkan dari middleware)
    useEffect(() => {
        if (!isInitialized && isLocationReady) {
            const detectedLocation = userLocation?.name || location;
            const initialMessage = `Halo! 👋 Saya WeatherGPT, asisten cuaca AI Anda.

📍 ${detectedLocation} | 🌡️ ${temperature}°C | ☁️ ${condition}

Tanya tentang cuaca, forecast, atau tips aktivitas. Apa yang bisa saya bantu?`;
     ...
     * Build weather context string untuk AI
     */
